...
ActiveRecord::Schema[7.1].define(version: 2024_05_03_090929) do
  ...
  create_table "accounts", force: :cascade do |t|
    ...
    t.bigint "interface_language_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["interface_language_id"], name: "index_accounts_on_interface_language_id"
  ...
  add_foreign_key "accounts", "languages", column: "interface_language_id"
